...
@section('description', 'Строительная компания СтройМастер37 работает в сфере строительных услуг города Иваново.Мы обладаем большим опытом в разных сферах строительства.Мастера нашей компании произведут ремонт пола,отделку потолка или стен на высшем уровне.')
@section('content')
                            ...
                            <article class="post-2573 page type-page status-publish hentry">
                                <div class="entry-content">
                                    <div id="pl-2573" class="panel-layout">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="{{ asset('storage/assets/img/fotoAboutAs.jpg') }}" alt="СтройМастер" style="width: 555px; height: 383px;" >
                                        </div>
                                        <div class="clear"></div>
                                        <hr>
                                        ...
                                        <div id="pg-2573-30" class="panel-grid panel-no-style">
                                            <div id="pgc-2573-30-0" class="panel-grid-cell">
                                                <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                    <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                        <div class="textwidget">
                                                            <img id="imgOrder" src="{{ asset('storage/assets/img/kosmRem.png') }}" style="width: 232px; height: 160px;">
                                                ...
                                                <!--  Модельное окно  -->
                                            @include('layouts.model-window-index')
                                            <!--  Модельное окно  -->
                                            </div>
                                            <div id="pgc-2573-30-0" class="panel-grid-cell">
                                                <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                    <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                        <div class="textwidget">
                                                            <img id="imgOrder" src="{{ asset('storage/assets/img/kapRem.png') }}" style="width: 232px; height: 160px;">
                                            ...
                                            <div id="pgc-2573-30-0" class="panel-grid-cell">
                                                <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                    <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                        <div class="textwidget">
                                                            <img id="imgOrder" src="{{ asset('storage/assets/img/dizProekt.png') }}" style="width: 232px; height: 160px;">
                                            ...
                                            <div id="pgc-2573-30-0" class="panel-grid-cell">
                                                <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                    <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                        <div class="textwidget">
                                                            <img id="imgOrder" src="{{ asset('storage/assets/img/butRem.png') }}" style="width: 232px; height: 160px;">
                                        ...
                                        <div class="row">
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/phone_72.png') }}" alt="Звонок">
                                                <p>Вы приходите к нам в офис или оставляете заявку на нашем сайте</p>
                                            </div>
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/prorab-72.png') }}" alt="Прораб">
                                                <p>Наш сотрудник связывается с вами и выезжает на замер в удобное для вас время</p>
                                            </div>
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/calculator.png') }}" alt="Смета">
                                                <p>Мы состовляем подробную смету</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/smeta_72.png') }}" alt="Договор">
                                                <p>Вы приезжаете к нам в офис и мы подписываем договор подряда</p>
                                            </div>
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/work.png') }}" alt="Работа">
                                                <p>Наши специалисты начинают работу</p>
                                            </div>
                                            <div class="work col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <img src="{{ asset('storage/assets/img/finish.png') }}" alt="Сдача объекта">
